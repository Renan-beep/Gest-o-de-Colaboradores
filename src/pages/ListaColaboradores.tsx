        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={filtros.sabadoTrabalho} onValueChange={(value) => setFiltros(prev => ({ ...prev, sabadoTrabalho: value }))}>
                <SelectTrigger>
                  <SelectValue placeholder="Todos" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select value={filtros.subsetor} onValueChange={(value) => setFiltros(prev => ({ ...prev, subsetor: value }))}>
                <SelectTrigger>
                  <SelectValue placeholder="Todos" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="todos">Todos</SelectItem>
                  {opcoesFiltros.subsetores.map(subsetor => (
                    <SelectItem key={subsetor} value={subsetor}>{subsetor}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={filtros.lideranca} onValueChange={(value) => setFiltros(prev => ({ ...prev, lideranca: value }))}>
                <SelectTrigger>
                  <SelectValue placeholder="Todos" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="todos">Todos</SelectItem>
                  {opcoesFiltros.liderancas.map(lideranca => (
            ...
            <div className="space-y-2">
              ...
              <Select value={filtros.turno} onValueChange={(value) => setFiltros(prev => ({ ...prev, turno: value }))}>
                ...
                <SelectContent>
                  <SelectItem value="todos">Todos</SelectItem>
                  {opcoesFiltros.turnos.map(turno => (
                       ...
                       <div className="flex gap-2">
                         {isGerencia ? (
                           ...
                           <Button 
                             ...
                             title="Visualizar detalhes do colaborador"
                           >
                             <Edit className="w-4 h-4 mr-1" />
                             Ver Detalhes
                           </Button>
